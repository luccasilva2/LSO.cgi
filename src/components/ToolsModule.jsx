    ...
    return (
        <div
            ...
            className={`absolute px-6 py-3 transition-all duration-200 
                        backdrop-blur-xl bg-slate-950/55 border border-cyan-200/10 shadow-[0_20px_40px_rgba(0,0,0,0.35)] rounded-full`}
            style={{
                left: position.x,
                top: position.y,
        ...
        >
            <div className="absolute inset-0 app-bg-noise opacity-15 pointer-events-none rounded-full"></div>
            ...
            <div className="flex justify-center gap-6 relative z-10">
                ...
                <button
                    ...
                    className={`p-3 rounded-full border-2 transition-all duration-300 ${isVideoOn
                        ? 'border-amber-400 bg-amber-500/10 text-amber-300 hover:bg-amber-500/20 shadow-[0_0_15px_rgba(243,179,108,0.3)]'
