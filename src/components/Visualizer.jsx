...
const Visualizer = ({ audioData, isListening, intensity = 0, width = 600, height = 400 }) => {
    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            ctx.strokeStyle = 'rgba(74, 217, 209, 0.14)';
            ctx.lineWidth = 2;
            ctx.stroke();
            ...
            if (!currentIsListening) {
                ...
                ctx.strokeStyle = 'rgba(74, 217, 209, 0.5)';
                ctx.lineWidth = 4;
                ctx.shadowBlur = 20;
                ctx.shadowColor = '#4ad9d1';
                ctx.stroke();
                ctx.shadowBlur = 0;
            } else {
                ...
                grad.addColorStop(0, 'rgba(74, 217, 209, 0.92)');
                grad.addColorStop(1, 'rgba(243, 179, 108, 0.88)');
                ctx.beginPath();
        ...
        <div className="relative" style={{ width, height }}>
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
                <motion.div
                    ...
                    className="text-cyan-50 font-bold tracking-[0.24em] drop-shadow-[0_0_15px_rgba(74,217,209,0.75)] text-center"
                    style={{ fontSize: Math.min(width, height) * 0.1 }}
                >
                    LSO
                    <div className="ui-mono text-[10px] tracking-[0.35em] text-cyan-200/65 mt-2">
                        LOGIC CORE
                    </div>
                </motion.div>
            </div>
