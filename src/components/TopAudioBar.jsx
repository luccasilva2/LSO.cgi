    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            for (let i = 0; i < totalBars / 2; i++) {
                ...
                const alpha = 0.2 + percent * 0.75;
                const warmMix = Math.min(1, i / (totalBars / 2));

                const r = Math.round(74 + (243 - 74) * warmMix);
                const g = Math.round(217 + (179 - 217) * warmMix);
                const b = Math.round(209 + (108 - 209) * warmMix);
